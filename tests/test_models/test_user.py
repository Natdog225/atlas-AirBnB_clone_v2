...
class TestUser(unittest.TestCase):
    ...
    def test_user_kwargs(self):
        ...
        new = User(first_name="John", last_name="Doe", email="john@example.com", password="secure123")
    ...
    def test_save_user(self):
        ...
        new = User(first_name="Jane", email="jane@example.com", password="password123")
        new.save()
        self.assertNotEqual(new.created_at, new.updated_at)

    def test_to_dict_user(self):
        """Test that User to_dict method includes correct attributes"""
        new = User(first_name="Alice", last_name="Wonder", email="alice@example.com")
